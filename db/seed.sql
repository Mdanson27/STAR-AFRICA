...
('user-site','company-star-africa','demo-site','site@starafrica.demo','Moses Kato','Projects','active',1788328800000,1788328800000),
...
('user-admin','role-super',1788328800000),('user-director','role-director',1788328800000),('user-finance','role-finance',1788328800000),('user-accountant','role-accountant',1788328800000),('user-bids','role-bids',1788328800000),('user-projects','role-project',1788328800000),('user-site','role-site',1788328800000),('user-procurement','role-procurement',1788328800000),('user-hr','role-hr',1788328800000),('user-auditor','role-auditor',1788328800000);
